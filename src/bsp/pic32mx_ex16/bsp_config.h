...
/* BSP LED state.
  ...
  Summary:
    Indiacated LED status.

  Description:
    This enumeration indicated the LED state.
...
typedef enum
{
    ...
    /* LED 4 */
    BSP_LED_4 = PORTS_BIT_POS_3,

    /* LED 5 */
    BSP_LED_5 = PORTS_BIT_POS_4,

    /* LED 6 */
    BSP_LED_6 = PORTS_BIT_POS_5,

    /* LED 7 */
    BSP_LED_7 = PORTS_BIT_POS_6,

    /* LED 8 */
    BSP_LED_8 = PORTS_BIT_POS_7
...
// *****************************************************************************
/* Function: void BSP_SwitchLED(BSP_LED led, BSP_LED_STATE state)

  Summary:
    Turns ON/OFF specified LED on the board.
  Description:
    This function turns ON/OFF specified LED on the board.
  Parameters:
    led: LED ID as specified by BSP_LED enum.
    state: BSP LED state as specified by BSP_LED_STATE
  Return:
    None
  Conditions:
...
// *****************************************************************************
/* Function: void BSP_LEDStatusGet(BSP_LED led)

  Summary:
    Gets the status of a specific LED on board.

  Description:
    This function gets the status of a specific LED on board.
