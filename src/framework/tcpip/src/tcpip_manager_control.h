...
#include "tcpip/tcpip_mac.h"
    ...
    #include "drv_wifi_config.h" // pull in additional defines from wireless settings
#endif
...
typedef struct
{
    ...
    PROTECTED_SINGLE_LIST         rxQueue;                // interface RX packet queue
                                                // ((__aligned__)) !!!
    ...
    union
    {
        struct
        {
            ...
            uint16_t reserved       : 11;       // available
        };
        uint16_t        v;
