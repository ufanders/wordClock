...
void  TCPIP_Helper_ProtectedSingleListAppend(PROTECTED_SINGLE_LIST* pL, SINGLE_LIST* pAList)
{
    ...
    TCPIP_Helper_SingleListAppend(&pL->list, pAList);
    if (OSAL_SEM_Post(pL->semaphore) != OSAL_RESULT_TRUE)
    {
        //SYS_DEBUG LOG
    }
...
void TCPIP_Helper_ProtectedSingleListDelete(PROTECTED_SINGLE_LIST* pL)
{
    ...
    TCPIP_Helper_SingleListDelete(&pL->list);
    if (OSAL_SEM_Post(pL->semaphore) != OSAL_RESULT_TRUE)
    {
        //SYS_DEBUG LOG
    }
    if (OSAL_SEM_Delete(pL->semaphore) != OSAL_RESULT_TRUE)
    {
        // SYS_DEBUG
    }
}
...
void TCPIP_Helper_ProtectedDoubleListDelete(PROTECTED_DOUBLE_LIST* pL)
{
    ...
    TCPIP_Helper_DoubleListDelete(&pL->list);
    if (OSAL_SEM_Post(pL->semaphore) != OSAL_RESULT_TRUE)
    {
        //SYS_DEBUG LOG
    }
