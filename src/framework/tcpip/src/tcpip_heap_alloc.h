 ...
 *                  tEntry      - address of a HEAP_TRACE_ENTRY that will be updated with corresponding info
 *
...
extern __inline__ bool __attribute__((always_inline)) TCPIP_HEAP_TraceGetEntry(TCPIP_HEAP_HANDLE heapH, int entryIx, HEAP_TRACE_ENTRY* tEntry)
{
    return false;
}

extern __inline__ int __attribute__((always_inline)) TCPIP_HEAP_TraceGetEntriesNo(TCPIP_HEAP_HANDLE heapH, bool used)
{
    return 0;
}
