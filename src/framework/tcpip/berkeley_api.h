...
#define SO_BROADCAST            6   //Enables the Socket for sending broadcast data - Not yet supported
...
/******************************************************************************
  Function:
    int  setsockopt(SOCKET s, uint32_t level, uint32_t option_name, uint8_t *option_value, uint32_t option_length)
