...
// Connections on port TCPIP_TELNET_SERVER_PORT will be ignored.  If
// TCPIP_STACK_USE_SSL_SERVER is undefined, this entire setting is ignored
// (server will accept unsecured connections on TCPIP_TELNET_SERVER_PORT and won't even
// listen on TCPIP_TELNET_SERVER_SECURE_PORT).
