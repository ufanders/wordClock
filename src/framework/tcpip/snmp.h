...
/*
  ...
  Parameters:
    index  -  One of the index of community table and it should be less than SNMP_MAX_COMMUNITY_SUPPORT.
	len - Length of the community string expected. It should not be more than SNMP_COMMUNITY_MAX_LEN.
