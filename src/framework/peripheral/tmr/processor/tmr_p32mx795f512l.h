...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_GatePolaritySelect(TMR_MODULE_ID index, TMR_GATE_POLARITY polarity)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsGatePolarity(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_GateToggleModeEnable(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_GateToggleModeDisable(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsGateToggleMode(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_GateSinglePulseModeEnable(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_GateSinglePulseModeDisable(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsGateSinglePulseMode(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_GateSinglePulseAcquisitionStart(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_GateSinglePulseAcquisitionHasCompleted(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsGateSinglePulseAcqusition(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_GateCurrentStateGet(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsGateCurrentState(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_GateSourceSelect(TMR_MODULE_ID index, TMR_GATE_SOURCE source)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsGateSource(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_TimerOscillatorEnable(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_TimerOscillatorDisable(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsTimerOscillator(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_Mode8BitEnable(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsMode8Bit(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_PostscaleSelect(TMR_MODULE_ID index, TMR_POSTSCALE postscale)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API TMR_POSTSCALE _PLIB_UNSUPPORTED PLIB_TMR_PostscaleGet(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API uint16_t _PLIB_UNSUPPORTED PLIB_TMR_PostscaleDivisorGet(TMR_MODULE_ID index, TMR_POSTSCALE postscale)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsPostscale(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_ClockSourceEdgeSelect(TMR_MODULE_ID index, TMR_CLOCK_SOURCE_EDGE source)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API TMR_CLOCK_SOURCE_EDGE _PLIB_UNSUPPORTED PLIB_TMR_ClockSourceEdgeGet(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsClockSourceEdge(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_PrescalerEnable(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_PrescalerDisable(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsPrescalerAssignment(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_AssignmentSelect(TMR_MODULE_ID index, TMR_ASSIGNMENT tmrNums)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsTimerAssignment(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_OperateInSleepEnable(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_OperateInSleepDisable(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsOperationInSleep(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_TriggerEventResetEnable(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_TriggerEventResetDisable(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsTriggerEventReset(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_ContinousCountModeEnable(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_SingleShotModeEnable(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsCountMode(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_Counter8BitSet(TMR_MODULE_ID index, uint8_t value)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API uint8_t _PLIB_UNSUPPORTED PLIB_TMR_Counter8BitGet(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_Counter8BitClear(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsCounter8Bit(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_TMR_Period8BitSet(TMR_MODULE_ID index, uint8_t period)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API uint8_t _PLIB_UNSUPPORTED PLIB_TMR_Period8BitGet(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsPeriod8Bit(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_SystemClockFromTimerIsActive(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_TMR_ExistsSystemClockStatus(TMR_MODULE_ID index)
{
    switch (index) {
        case TMR_ID_1 :
