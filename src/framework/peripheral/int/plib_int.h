...
/*
  ...
  Remarks:
    ...
    This feature may not be available on all devices.  
    Please refer to the specific device data sheet to determine availability 
    or use the PLIB_INT_ExistsINTNesting function 
    in your application to determine whether this feature is available.
*/
...
/*
  ...
  Remarks:
    ...
    This feature may not be available on all devices.  
    Please refer to the specific device data sheet to determine availability 
    or use the PLIB_INT_ExistsTrapSource function 
    in your application to determine whether this feature is available.
*/
...
/*************************************************************************
  ...
  Remarks:
    ...
    This feature may not be available on all devices.  
    Please refer to the specific device data sheet to determine availability 
    or use the PLIB_INT_ExistsAlternateVectorTable function 
    in your application to determine whether this feature is available. 
*/
...
/*
  ...
  Remarks:
    ...
    This feature may not be available on all devices.  
    Please refer to the specific device data sheet to determine availability 
    or use the PLIB_INT_ExistsPeripheralControl function 
    in your application to determine whether this feature is available. 
*/
...
/*
  ...
  Remarks:
    ...
    This feature may not be available on all devices.  
    Please refer to the specific device data sheet to determine availability 
    or use the PLIB_INT_ExistsHighPriority function 
    in your application to determine whether this feature is available. 
*/
...
/*
  ...
  Remarks:
    ...
    This feature may not be available on all devices.  
    Please refer to the specific device data sheet to determine availability 
    or use the PLIB_INT_ExistsLowPriority function 
    in your application to determine whether this feature is available. 
*/
...
/*
  ...
  Remarks:
    ...
    This feature may not be available on all devices.  
    Please refer to the specific device data sheet to determine availability 
    or use the PLIB_INT_ExistsPriority function 
    in your application to determine whether this feature is available. 
*/
...
/*
  ...
  Remarks:
    ...
    This feature may not be available on all devices.  
    Please refer to the specific device data sheet to determine availability 
    or use the PLIB_INT_ExistsDISI function 
    in your application to determine whether this feature is available. 
*/
