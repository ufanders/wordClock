...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_OSC_ExistsPBClockReady(OSC_MODULE_ID index)
{
    switch (index) {
        case OSC_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_OSC_ExistsReferenceOscBaseClock(OSC_MODULE_ID index)
{
    switch (index) {
        case OSC_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_OSC_ExistsReferenceOscChange(OSC_MODULE_ID index)
{
    switch (index) {
        case OSC_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_OSC_ExistsReferenceOscChangeActive(OSC_MODULE_ID index)
{
    switch (index) {
        case OSC_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_OSC_ExistsReferenceOscStopInSleep(OSC_MODULE_ID index)
{
    switch (index) {
        case OSC_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_OSC_ExistsReferenceOutputEnable(OSC_MODULE_ID index)
{
    switch (index) {
        case OSC_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_OSC_ExistsReferenceOscStopInIdleEnable(OSC_MODULE_ID index)
{
    switch (index) {
        case OSC_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_OSC_ExistsReferenceOscEnable(OSC_MODULE_ID index)
{
    switch (index) {
        case OSC_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_OSC_ExistsReferenceOscDivisor(OSC_MODULE_ID index)
{
    switch (index) {
        case OSC_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_OSC_ExistsReferenceOscTrim(OSC_MODULE_ID index)
{
    switch (index) {
        case OSC_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_OSC_ExistsPBClockOutputEnable(OSC_MODULE_ID index)
{
    switch (index) {
        case OSC_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_OSC_ExistsSysPLLInputDivisor(OSC_MODULE_ID index)
{
    switch (index) {
        case OSC_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_OSC_ExistsSysPLLInputClockSource(OSC_MODULE_ID index)
{
    switch (index) {
        case OSC_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_OSC_ExistsSysPLLFrequencyRange(OSC_MODULE_ID index)
{
    switch (index) {
        case OSC_ID_0 :
