...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_DEVCON_ExistsAlternateClock(DEVCON_MODULE_ID index)
{
    switch (index) {
        case DEVCON_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_DEVCON_ExistsDeviceRegsLockUnlock(DEVCON_MODULE_ID index)
{
    switch (index) {
        case DEVCON_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_DEVCON_ExistsUSB_PHY_SleepModeSet(DEVCON_MODULE_ID index)
{
    switch (index) {
        case DEVCON_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_DEVCON_ExistsECCModes(DEVCON_MODULE_ID index)
{
    switch (index) {
        case DEVCON_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_DEVCON_ExistsIgnoreDebugFreeze(DEVCON_MODULE_ID index)
{
    switch (index) {
        case DEVCON_ID_0 :
