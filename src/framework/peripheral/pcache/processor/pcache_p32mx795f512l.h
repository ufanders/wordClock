...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_PCACHE_ExistsFlashSECInt(PCACHE_MODULE_ID index)
{
    switch (index) {
        case PCACHE_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_PCACHE_ExistsFlashDEDStatus(PCACHE_MODULE_ID index)
{
    switch (index) {
        case PCACHE_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_PCACHE_ExistsFlashSECStatus(PCACHE_MODULE_ID index)
{
    switch (index) {
        case PCACHE_ID_0 :
...
PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_PCACHE_ExistsFlashSECCount(PCACHE_MODULE_ID index)
{
    switch (index) {
        case PCACHE_ID_0 :
