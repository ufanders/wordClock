...
ETH_RESULT_CODE DRV_EXTPHY_MIIConfigure(DRV_HANDLE hClientObj,ETHPHY_CONFIG_FLAGS cFlags)
{
	...
	DRV_ETHPHY_SMIReadStart(hClientObj,PHY_REG_UTP_CONTROL_MODE);
	...
	DRV_ETHPHY_SMIWriteStart(hClientObj,PHY_REG_UTP_CONTROL_MODE, phyReg);	// update the RMII and Bypass Register
...
ETH_RESULT_CODE DRV_EXTPHY_MDIXConfigure(DRV_HANDLE hClientObj, ETH_OPEN_FLAGS oFlags)
{
    ...
    {   // enable Auto-MDIX
        ...
        DRV_ETHPHY_SMIWriteStart(hClientObj,PHY_REG_UTP_CONTROL_MODE, phyReg);   
    }
    else
    {	// no Auto-MDIX It is a Forced MDIX
        ...
        DRV_ETHPHY_SMIWriteStart(hClientObj,PHY_REG_PAGE_SEL, PAGENUM_16);  
        DRV_ETHPHY_SMIReadStart(hClientObj,PHY_REG_MDIX_CNTL_SPFC_STATUS);
        phyReg=DRV_ETHPHY_SMIReadResultGet(hClientObj);
        ...
        DRV_ETHPHY_SMIWriteStart(hClientObj,PHY_REG_MDIX_CNTL_SPFC_STATUS, phyReg);   
    }
