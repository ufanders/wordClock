...
// *****************************************************************************
/* Function:
    size_t DRIVER DRV_USART_Read(DRV_HANDLE hClient, void * destination, 
                                 size_t nBytes)

  Summary:
    Dynamic impementation of DRV_USART_Read client interface function.

  Description:
    This is the dynamic impementation of DRV_USART_Read client interface
    function.
...
// *****************************************************************************
/* Function:
    size_t DRIVER DRV_USART_Write(DRV_HANDLE hClient, void * source, size_t nBytes)

  Summary:
    Dynamic impementation of DRV_USART_Write client interface function.

  Description:
    This is the dynamic impementation of DRV_USART_Write client interface function.
