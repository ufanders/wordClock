...
/* Function:
  ...
  Description:
    This function supports the set up of the PIC32 Ethernet MAC.  Used by tcpip_module_manager.
  ...
  Returns:
    - TCPIP_MAC_RES_OK if initialization completed
    - a TCPIP_MAC_RES error value if the initialization failed
...
/***************************************************************************************************************************
  ...
  Summary:
    Copies the PIC32 Ethernet MAC configuration.

  Description:
    This function copies the PIC32 Ethernet MAC configuration parameters into a user supplied
    buffer.
  ...
  Parameters:
    modId       - Module ID from TCPIP_STACK_MODULE enumeration,
                  identifying the MAC
    configBuff  - Pointer to configuration buffer to store the configuration into
    buffSize    - Size of configuration buffer provided by configBuff
    pConfigSize - Pointer to the size of configuration info
...
/******************************************************************************
  ...
  Summary:
    Ethernet MAC driver interrupt finction.

  Description:
    This is the Ethernet MAC driver intrerrupt service routine.
