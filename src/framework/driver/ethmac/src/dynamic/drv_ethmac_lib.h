...
/*******************************************************************************
  Function:
    ETH_RESULT_CODE DRV_ETHMAC_LibRxPendingBuffersGet(DRV_ETHMAC_INSTANCE_DCPT* pMacD, int* pnBuffs)
  ...
  Returns:
    ETH_RES_OK  - the number of buffers was returned OK
...
/*******************************************************************************
  Function:
    ETH_RESULT_CODE DRV_ETHMAC_LibTxPendingBuffersGet(DRV_ETHMAC_INSTANCE_DCPT* pMacD, int* pnBuffs)
