...
#ifndef DRV_TMR_PRESCALER_ENABLE

    #define DRV_TMR_PRESCALER_ENABLE            DRV_CONFIG_NOT_SUPPORTED

#endif

#ifndef DRV_TMR_ASYNC_WRITE_ENABLE

    #define DRV_TMR_ASYNC_WRITE_ENABLE          DRV_CONFIG_NOT_SUPPORTED
...
*/
    ...
    #define DRV_TMR_VersionGet(sysID)                   _DRV_TMR_MAKE_NAME(VersionGet)()

    #define DRV_TMR_VersionStrGet(sysID)                _DRV_TMR_MAKE_NAME(VersionStrGet)()
